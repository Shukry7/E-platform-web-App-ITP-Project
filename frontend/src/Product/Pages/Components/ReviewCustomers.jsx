...
const ReviewCustomer = ({ ProductID, reference, Rating }) => {
      ...
      <section class="bg-white antialiased dark:bg-gray-900 md:pb-16">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
          <div class="my-6 gap-8 sm:flex sm:items-start md:my-8">
                ...
                <div key={rating} className="flex items-center gap-2">
                  ...
                  <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
                    <div
                      ...
                      style={{
                        width: `${(ratingCount[rating] / totalRatings) * 100}%`,
                      }}
                    ></div>
                  </div>
                  <a
            ...
            <Review ProductID={ProductID} setTemp={setTemp} temp={temp} />
          </div>
          ...
          <div
            ...
            ref={reference}
          >
            {productReviews.slice(0, AddRow).map((ProductR, index) => {
              let formattedDate = "";
