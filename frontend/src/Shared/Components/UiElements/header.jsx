...
const Header = () => {
  return (
    <>
      <nav class="sticky z-20 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
              ...
              <div
                ...
                style={{position: "absolute" , inset: "0px auto auto 0px" , margin: "0px", transform: "translate3d(1348.8px, 64.8px, 0px)"}}
              ...
              >
                ...
                <div
                  class="tooltip-arrow"
                  data-popper-arrow=""
                  style={{position: "absolute", left: "0px", transform: "translate3d(68.8px, 0px, 0px)"}}
                ></div>
              </div>
